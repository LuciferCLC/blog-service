...
class BookController {
  ...
  static async getBooks (ctx) {
    ...
    if (book) {
      ...
      handleError({ ctx, message: '获取书本列表失败' })
    }
  }
  ...
  static async postBook (ctx) {
    ...
    if (book) {
      handleSuccess({ ctx, message: '发布书本成功', result: book })
    } else {
      handleError({ ctx, message: '发布书本失败' })
    }
  }
  ...
  static async patchBook (ctx) {
    ...
    if (res) {
      handleSuccess({ ctx, message: '更新数据状态成功'})
    } else {
      handleError({ ctx, message: '更新数据状态失败' })
    }
  }
  ...
  static async putBook (ctx) {
    ...
    if (res) {
      handleSuccess({ ctx, message: '修改数据成功' })
    } else {
      handleError({ ctx, message: '修改数据失败' })
    }
  }
